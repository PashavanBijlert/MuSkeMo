...
% \begin{wrapfigure}{l}{0.5\textwidth} % 'r' for right alignment
%     \vspace{-15pt}
%     \centering
%     \includegraphics[width=\linewidth]{figures/panels.png} % Add image
%     %\captionsetup{width=0.5\linewidth}
%     \caption{MuSkeMo's panels. Panels can be interactively resized and collapsed}
%     \label{fig:panels}
%     \vspace{-25pt}
% \end{wrapfigure}

% \begin{wrapfigure}{r}{0.4\textwidth} % 'r' for right alignment
%     \vspace{-45pt}
%     \centering
%     \includegraphics[width=\linewidth]{figures/collections.png} % Add image
%     %\captionsetup{width=0.5\linewidth}
%     \caption{Model components are stored in Blender collections. If child objects are not visible, turn off object children in the outliner filter (see Section \ref{sec:MSM_glob_settings}}.
...
%     %\vspace{-15pt}
%     \centering
%     \includegraphics[width=\linewidth]{figures/custom_properties.png} % Add image
%     %\captionsetup{width=0.5\linewidth}
%     \caption{After creating or importing model components, they are stored in Blender's collections. If child objects are not visible, turn off object children in the outliner filter (see Section \ref{sec:MSM_glob_settings}}.
%     \label{fig:custom_properties}
%     %\vspace{-15pt}
% \end{wrapfigure}
...
To compute the volumetric inertia tensor (with elements \si{m^5}) of a triangular mesh, MuSkeMo implements the solution derived and presented in \cite{eberlyGamePhysics2004} which is based on the Divergence Theorem. The volumetric tensor is multiplied by density to acquire the inertial tensor elements. This algorithm requires the mesh to be triangulated and watertight to provide meaningful results, and MuSkeMo alerts the user if this is not the case.
