...
\subsubsection{New mesh from selected faces (Edit mode)}
\label{sec:newmeshselfaces}
...
\item In the mesh tools panel (sec. \ref{sec:meshtools}), press ``New mesh from selected faces" (see sec. \ref{sec:newmeshselfaces} for details.). This creates a new mesh object.
...
The functions will fit the entire mesh that you select, so if you want to fit a portion of the mesh (e.g., the femoral head), use the ``New mesh from selected faces" button (see sec. \ref{sec:newmeshselfaces} for details).
