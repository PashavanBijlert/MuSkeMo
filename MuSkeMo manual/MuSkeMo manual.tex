...
We can also fill in the result from eq. \ref{eq:Rmatreexpress} to expand the expression in terms global rotation matrices, and then simplify as much as possible:
...
We can combine the results from eqs. \ref{eq:locglobRx}, \ref{eq:Rmatreexpress}, and \ref{eq:Rmatzreexpressed} to write out the entire expanded matrix multiplication:
