...
The density specified at the top of the panel is used for all inertial properties calculations (default = 1000 \unit{kg m^{-3}}). It is possible to change the density property of an object, after which you will have to select the object and rerun "Compute for selected meshes". 
