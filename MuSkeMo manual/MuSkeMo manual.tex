...
The theoretical ideal translations and orientations plotted in fig. \ref{fig:posesamplestresstest} are derived in the supplementary information of \cite{bishopIntelligentSamplingHighdimensional2023}. The Matlab code that generates FIGURE is provided with the Blender scene \href{https://github.com/PashavanBijlert/MuSkeMo/releases/tag/v0.x-posesamplestresstest}{on Github}
