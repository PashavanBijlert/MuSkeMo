...
\textbf{Warning:} While the moment arms computed by MuSkeMo are physically accurate (Fig. \ref{fig:momentarmscombined}), they are slightly noisy, in the order of 0.4\% of the value of the moment arm, see \ref{sec:momentarmvalidation} for details.
