...
\(i\) denotes the icosahedron, and \(c\) signifies the inertia is given with respect to its center of mass. Like in \ref{sec:eulerangles}, \(\mathcal{G}\) signifies the tensor is expressed in the global frame.

The sphere has mass \(m_{s}\) = 4188.79 \si{kg}, centered at (4,1,-1.5) \si{m}, and its inertia tensor:
...
\begin{equation}
    \frac{m_{i} \cdot \begin{bmatrix} 0 \\ 0 \\ 0 \end{bmatrix}  + m_{s} \cdot \begin{bmatrix} 4 \\ 1 \\ -1.5 \end{bmatrix}}{m_{i} + m_{s}},
\end{equation}

which is at (2.4915, 0.6229, -0.9343) \si{m} in the \(\mathcal{G}\)-frame.
