...
If a muscle uses wrapping, the wrapped points are projected onto the wrap geometry using a raycast node (\ref{sec:musclewrapping}). This currently results in some noise when computing moment arms. FIGURE COMPARISON TO FOLLOW.
